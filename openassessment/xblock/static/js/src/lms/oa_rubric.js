...
export class Rubric {
  constructor(element) {
    ...
    this.criterionFeedback = this.criterionFeedback.bind(this);
    this.overallFeedback = this.overallFeedback.bind(this);
    this.optionsSelected = this.optionsSelected.bind(this);
    this.canSubmitCallback = this.canSubmitCallback.bind(this);
    this.canSubmit = this.canSubmit.bind(this);
    this.changesExistCallback = this.changesExistCallback.bind(this);
    this.changesExist = this.changesExist.bind(this);
    this.showCorrections = this.showCorrections.bind(this);
    this.getCriterionName = this.getCriterionName.bind(this);
  }
