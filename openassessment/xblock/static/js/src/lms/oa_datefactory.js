...
export class DateTimeFactory {
  constructor(element) {
    ...
    this.determineContext = this.determineContext.bind(this);
    this.determineDateToken = this.determineDateToken.bind(this);
    this.elementApply = this.elementApply.bind(this);
