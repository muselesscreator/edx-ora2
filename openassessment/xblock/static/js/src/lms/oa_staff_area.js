...
export class StaffAreaView {
  ...
  constructor(element, server, baseView) {
    ...
    this.confirmSubmitGradeForTeam = this.confirmSubmitGradeForTeam.bind(this);
    this.loadStaffGradeForm = this.loadStaffGradeForm.bind(this);
    this.closeStaffGradeForm = this.closeStaffGradeForm.bind(this);
    ...
    this.cancelSubmissionEnabled = this.cancelSubmissionEnabled.bind(this);
    this.comment = this.comment.bind(this);
    this.handleCommentChanged = this.handleCommentChanged.bind(this);
    this.staffSubmitEnabled = this.staffSubmitEnabled.bind(this);
    this.assessmentRubricChanges = this.assessmentRubricChanges.bind(this);
    this.submitStaffOverride = this.submitStaffOverride.bind(this);
    this.submitStaffGrade = this.submitStaffGrade.bind(this);
    this.callStaffAssess = this.callStaffAssess.bind(this);
  }
      ...
      if (studentUsername.trim()) {
          this.server.studentInfo(studentUsername).done(function(html) {
              ...
              if ($rubric.size() > 0) {
                  ...
                  var rubric = new Rubric(rubricElement);
