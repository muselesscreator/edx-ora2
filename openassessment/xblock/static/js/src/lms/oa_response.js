...
export class ResponseView {
  ...
  constructor(element, server, fileUploader, baseView, data) {
    ...
    this.checkSubmissionAbility = this.checkSubmissionAbility.bind(this);
    this.checkSaveAbility = this.checkSaveAbility.bind(this);
    this.submitEnabled = this.submitEnabled.bind(this);
    this.saveEnabled = this.saveEnabled.bind(this);
    this.uploadEnabled = this.uploadEnabled.bind(this);
    this.previewEnabled = this.previewEnabled.bind(this);
    this.hasPendingUploadFiles = this.hasPendingUploadFiles.bind(this);
    this.hasAllUploadFiles = this.hasAllUploadFiles.bind(this);
    ...
    this.updateFilesDescriptions = this.updateFilesDescriptions.bind(this);
    this.removeFilesDescriptions = this.removeFilesDescriptions.bind(this);
    this.getSavedFileCount = this.getSavedFileCount.bind(this);
    this.removeUploadedFile = this.removeUploadedFile.bind(this);
    this.confirmRemoveUploadedFile = this.confirmRemoveUploadedFile.bind(this);
    this.getFileNameAndDescription = this.getFileNameAndDescription.bind(this);
