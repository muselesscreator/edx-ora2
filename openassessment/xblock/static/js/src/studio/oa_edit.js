...
export class StudioView {
  constructor(runtime, element, server, data) {
    ...
    var studentTrainingListener = new StudentTrainingListener();
    ...
    var staffAssessmentView = new EditStaffAssessmentView(
        $('#oa_staff_assessment_editor', this.element).get(0)
    );
    var studentTrainingView = new EditStudentTrainingView(
        $('#oa_student_training_editor', this.element).get(0)
    );
    var peerAssessmentView = new EditPeerAssessmentView(
        $('#oa_peer_assessment_editor', this.element).get(0)
    );
    var selfAssessmentView = new EditSelfAssessmentView(
    ...
    this.fixModalHeight = this.fixModalHeight.bind(this);
    this.initializeTabs = this.initializeTabs.bind(this);
    this.saveTabState = this.saveTabState.bind(this);
    this.save = this.save.bind(this);
    this.confirmPostReleaseUpdate = this.confirmPostReleaseUpdate.bind(this);
...
export function oaTinyMCE(options) {
