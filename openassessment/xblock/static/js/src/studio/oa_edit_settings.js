...
export class EditSettingsView {
  constructor(element, assessmentViews, data) {
    ...
    this.initializeSortableAssessments = this.initializeSortableAssessments.bind(this);
    this.displayName = this.displayName.bind(this);
    this.submissionStart = this.submissionStart.bind(this);
    this.submissionDue = this.submissionDue.bind(this);
    ...
    this.assessmentsDescription = this.assessmentsDescription.bind(this);
    this.editorAssessmentOrder = this.editorAssessmentOrder.bind(this);
