...
export class StudentTrainingListener {
  constructor() {
    ...
    this.optionUpdated = this.optionUpdated.bind(this);
    this.optionAdd = this.optionAdd.bind(this);
    this.optionRemove = this.optionRemove.bind(this);
    this._optionSel = this._optionSel.bind(this);
    this.removeAllOptions = this.removeAllOptions.bind(this);
    this.criterionRemove = this.criterionRemove.bind(this);
    this.displayAlertMsg = this.displayAlertMsg.bind(this);
    this.criterionUpdated = this.criterionUpdated.bind(this);
    this.criterionAdd = this.criterionAdd.bind(this);
    this.examplesCriteriaLabels = this.examplesCriteriaLabels.bind(this);
    this.examplesOptionsLabels = this.examplesOptionsLabels.bind(this);
  }
